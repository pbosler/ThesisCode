...
integer(kint), parameter :: problemID = STRATOSPHERE_MODEL
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	if ( procRank == 0) then
		...
		open(unit=readUnit,file='StratospherePanels.namelist',action='READ',status='OLD',iostat=readStat)
			if (readstat /= 0 ) then
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	call InitStratosphere(gridParticles,gridPanels)
	if ( AMR > 0 ) then
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	do timeJ = 0,timesteps-1
		...
		! Advance time
		call StratosphereRK4(gridParticles,gridPanels,t,dt,procRank,numProcs)
