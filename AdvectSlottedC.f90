...
integer(kint) :: problemID=SLOTTED_CYLINDERS
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	if ( procRank == 0) then
		...
		open(unit=readUnit,file='AdvectSlotC.namelist',action='READ',status='OLD',iostat=readStat)
			if (readstat /= 0 ) then
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	call InitSlottedCylinders(gridParticles,gridPanels)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
	...
	do j=1,gridPanels%N
		if ( .NOT. gridPanels%hasChildren(j) ) then
			gridPanels%tracer(j,2) = abs( SlottedCylindersX(gridPanels%x(:,j)) - gridPanels%tracer(j,1))
		endif
	enddo
